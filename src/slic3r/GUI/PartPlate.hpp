...
public:
    ...
    void set_gcode_result(GCodeResult* result);
    ...
    template<class Archive> void load(Archive& ar) {
        ...
        ar(m_plate_index, m_name, m_print_index, m_origin, m_width, m_depth, m_height, m_locked, m_selected, m_ready_for_slice, m_slice_result_valid, m_helio_result_valid, m_apply_invalid, m_printable, m_tmp_gcode_path, objects_and_instances, instances_outside, m_config);
