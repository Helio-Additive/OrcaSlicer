...
public:
    ...
    wxBoxSizer *create_item_input(wxString title, wxString title2, wxWindow *parent, wxString tooltip, std::string param, wxTextValidatorStyle validator_filter,std::function<void(wxString)> onchange = {});
