...
{
public:
    HelioCompletionEvent(wxEventType eventType,
                         int         winid,
                         std::string in_path,
                         std::string in_tmp_path,
                         bool        in_is_successful,
                         std::string in_error_message = "",
                         int         ac               = 0,
                         std::string mean_impro       = "",
                         std::string std_impro        = "")
        : wxEvent(winid, eventType)
        , tmp_path(in_tmp_path)
        , path(in_path)
        , is_successful(in_is_successful)
