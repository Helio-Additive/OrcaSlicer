...
void CustomToggleButton::on_left_down(wxMouseEvent& e) { SetIsSelected(true); }
...
bool CustomToggleButton::IsSelected() const { return m_isSelected; }
    ...
    : wxPanel(parent, id, pos, size)
{
    ...
    Bind(wxEVT_ENTER_WINDOW, [=](auto& e) { auto a = 1; });
